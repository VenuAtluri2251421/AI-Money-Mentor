...
def explain_insight(
    ...
    FIXME: The income figure passed here is annual but prompts say "per month" for some types.
           Standardise the prompt templates to consistently use annual income.
    """
