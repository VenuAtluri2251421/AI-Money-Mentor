  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-secondary)' }}>
      ...
      <div className="container" style={{ padding: '48px 24px', textAlign: 'center' }}>
        ...
        <h1 style={{ marginBottom: 12 }}>Life Event Advisor</h1>
        <p style={{ color: 'var(--text-secondary)', maxWidth: 480, margin: '0 auto 32px' }}>
          Tailored allocation strategies for bonuses, inheritance, marriage, job changes, and more — personalized by Claude.
        </p>
